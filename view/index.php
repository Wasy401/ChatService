  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <body>  
        <div class="container">
			...
			<h3 align="center">Chat With your Heart!<br />
			<br />
			<div class="row">
				...
				<div class="col-md-2 col-sm-3">
					<p align="right">Hi - <?php echo $_SESSION['username']; ?> - <a href="../controller/logout.php">Logout</a></p>
				</div>
			</div>
	...
	<div class="form-group">
		...
		<div class="chat_message_area">
			...
			<div class="image_upload">
				<form id="uploadImage" method="post" action="../controller/upload.php">
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"../model/update_last_activity.php",
			success:function()
			{
	...
	$(document).on('focus', '.chat_message', function(){
		var is_type = 'yes';
		$.ajax({
			url:"../model/update_is_type_status.php",
			method:"POST",
